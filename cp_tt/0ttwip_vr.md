...
22. 2016 - Nintendo released Pokémon GO as an AR experience, with Pokémon being overlaid over a phone's [camera](camera.md). This created some issues because some people were being *very* unsafe with auto traffic with the intent to play the game.
