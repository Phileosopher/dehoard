...
|
 ...
 | ORGANIC | INORGANIC |
| No stress | Either recovery or decay | Low-level entropy |
| Low-level stress | Hormesis (gets stronger) | Material fatigue (gets weaker) |
| High-level stress | Trauma | Breakage |
...
- Sharp objects like glass must be protectively sealed to prevent anyone being harmed by it.
