...
In the spirit of that simplicity, Scratch is probably the best programming language for easy accessibility. It uses a convenient [GUI](engineering-graphics.md) that makes it *very* [kid-friendly](parenting-2_children.md).
