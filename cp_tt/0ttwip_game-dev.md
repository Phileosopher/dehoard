...
While [web-based](computers-webdev.md) PC game platforms in the late-2010s (e.g., Steam, GOG) have leveled the competitive playing field a bit, there's still a stark discrepancy between the risk-taking [artist](mind-creativity.md) indie game developers and the mass-produced corporate AAA game development team.
...
- Community support roles, such as [customer support](customerservice.md).
