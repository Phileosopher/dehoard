...
- A climate like the one we know, but with a different [atmosphere](jobs-spcialization.md) or ecosystem.
...
Beauty is relative, but not entirely. Its staying power comes in how much *inherent* quality it has, which is mostly based on the creator's [raw skill](mind-creativity.md).
...
The culture surrounding a creation is not the creation itself, and often builds a [story](stories.md) around the thing to give it a false [reputation](image.md). Don't condemn or venerate a creation just because [everyone else](trends.md) seems to be.
