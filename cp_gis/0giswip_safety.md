...
When we have safety right now, and don't have [predictions](imagination.md) that it'll change in the future, we have "peace".

## Risk

Risk can most accurately be rephrased as "the [likelihood](imagination.md) that we could lose [power](power.md)". [Risks are inherent](trust.md) to existing in this life, so people become more careful and decisive as they gain [wisdom](understanding.md). With experience, people only act when they're [certain](understanding-certainty.md).
...
The entire point of *any* security/safety system is from vague [trust](trust.md) issues:
...
Finally, some [creative](mind-creativity.md) defenders will try to make the intruder waste their time on something unimportant:
