...
While many people imagine good and evil on a spectrum, evil is more an *absence* of [virtue](morality.md):
...
Most [religious institutions](religion.md) provoke us to virtue, at least partly.
...
Often, this arrogance transitions into the desire to [transcend death](legacy.md).
...
Evil [purposes](purpose.md) are frequently a shortcut to a comparably virtuous purpose.

The competitive drive to be better than others is why many [systems can turn evil](mgmt-badsystems.md).
...
Everyone is about 20-50 key [decisions](decisions.md) away from becoming evil. [Virtue](morality.md) hurts us in the short-term, so all we'd need to do is submit to our baser desires and disregard others.

If it [feels](mind-feelings.md) good, we should only do it unquestionably if it also feels good for everyone else, present and future.
