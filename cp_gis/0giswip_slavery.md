...
- Living in a [ghetto](classes.md) with the ability to self-educate and leave it
- Working a job where there are [opportunities](power.md) to change the situation
- Having [debt](money-2_debt.md) that can be repaid relatively quickly
...
People who are temporary slaves are bound by either an [agreement](people-contracts.md) or a [purpose](purpose.md). But, they can often choose a different arrangement later on.
