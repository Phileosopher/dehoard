...
## What some people say about hygiene and Tact

There are [many social rules](people-rules.md), and honoring the local culture is important.

However, the most significant rule is to [manage how you smell](people-2_image.md).

- A society that has extremely affordable soap and laundry detergent expects people to use it profusely.
- While it doesn't mean you have to have *no* smell, it *does* mean that people are more sensitive to it.
- Unfortunately, it's considered impolite in many circles to indicate to someone that they smell bad.
...
## What nobody says about marketing

The West is filled with [marketing](marketing.md) lies, but most people raised in it are immune to it.

- They've been fed [lies](people-lying.md) and [propaganda](stories-storytellers.md) since they were young, so they're typically aware of most [image distortion methods](image-distortion.md).

Further, these lies are often *heavily* reinforced for the purpose of selling [debt](money-2_debt.md).
...
- However, a few predatory contracts will create a debt-based situation that will function effectively like [indentured servitude](slavery.md).

No matter what, [stay legally safe](legal-safety.md) by only consenting to what you understand.

## What nobody says about reputation
...
3. You trust that second-degree or third-degree person from how others trust that person.
...
However, about 90% of the USA runs on this reputation-by-legal-fiction, meaning you are a database entry to them, with [customer service requirements](customerservice.md) to prevent that walking dataset from moving to another provider.
...
[Culturally](culture.md), many people [identify](identity.md) themselves by their discrete, arbitrary measurement.
...
- Never trust the [marketing](marketing.md): everyone [lies](people-lying.md) and [distorts the truth](image-distortion.md) until you're [reading a contract](people-6_contracts.md).
...
- Know [how to use a computer](computers.md).
- Maintain [hygiene](people-2_image.md) *every* day you're around other people.
