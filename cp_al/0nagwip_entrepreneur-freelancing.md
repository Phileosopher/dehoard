...
- If you lose money on some of them, you're fine as long as you do other tasks that [pay the bills](money-3_budget.md).
- Like [investing](money-investing.md), small one-off jobs and ideas will diversify your income streams.

However, for many industries, you *will* need to invest a certain amount of money and time.

- To offset the money you'll need, [budget](money-3_budget.md) and [save](money-saving.md) for the business as much as possible *before* you start into it.
...
4. Low-demand (e.g., medieval-period armor fabrication, [VR headset](computers-vr.md) consultation).
   - The idea may be sound, but [premature](trends.md).
...
- Manual labor
- Trench digging
- [Pet](fun-pets.md) sitting, grooming or walking
...
- Look for [tax-favored](accounting.md) improvements and tax rebates for various lifestyle decisions.
...
4. Use other similar items for sale to determine where to sell it:
   ...
   - E-tailer site, classified ads - be prepared to [haggle](people-5_conflicts.md) and lower your price.
