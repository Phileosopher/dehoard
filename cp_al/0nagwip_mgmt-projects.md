...
*Previous: [What is a Manager?](mgmt-1_why.md)*
...
Before even *beginning* to dive into [teams](mgmt-3_teams.md) and [projects](mgmt-2_projects.md), build a clear [vision](imagination.md) of what the team will need to do:
...
- These values are [philosophical concepts](values.md) that take precedence over others (e.g., kindness, strength, curiosity).
...
There are a variety of existing project systems to choose from, and even more if you draw inspiration from [logistics](logistics.md).
...
- The original idea was from [software development](programming-basics.md), where the goals and possible risks aren't always perfectly clear.
...
- From a [different perspective](mind-creativity-how.md), most risks can actually be advantages (e.g., [unemployment](hardship-unemployment.md) creates available free time).
...
- Your [natural disposition](personality.md) to favor anyone differently than the last manager is guaranteed to create workplace politics.
- Most of the group will *not* adapt quickly to your approach, but the ones who do may simply be [power-hungry](power.md).

*Next: [Hiring & Firing Teams](mgmt-3_teams.md)*
